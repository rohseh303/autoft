...
MODEL_REGISTRY: dict[str, str] = {
    # "Qwen3.5-2B" is a display label. unsloth/Qwen3.5-2B on HF is an
    # image-text-to-text (vision) model that crashes text tokenization, so map
    # the label to a real small TEXT model.
